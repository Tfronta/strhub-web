export const translations = {
  en: {
    ...
    marker: {
      ...
      reference: "Reference: NIST STRBase. Available at: https://strbase.nist.gov/",
  ...
  pt: {
    ...
    marker: {
      ...
      reference: "Referência: NIST STRBase. Disponível em: https://strbase.nist.gov/",
  ...
  es: {
    ...
    marker: {
      ...
      reference: "Referencia: NIST STRBase. Disponible en: https://strbase.nist.gov/",
