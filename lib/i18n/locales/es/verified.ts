export default {
  verified: {
    ...
    files: {
      ...
      html: "Copia HTML",
      json: "Registro JSON",
      note: "Los escribe el motor al terminar la corrida, a partir del mismo registro que muestra esta página. El PDF es el que se adjunta a una revisión; la copia HTML se abre en cualquier lado, sin STRhub.",
    },
    footnote:
    ...
    dispute: {
      ...
      orEmail: "¿Preferís no usar GitHub? Escribile al equipo de STRhub:",
      mailSubject: "Sobre la atestación de STRhub Verified",
    },
    group: {
      commits: "{n} verificaciones",
      commitSingular: "1 verificación",
    },
    history: {
      ...
      older: {
        title: "Estás leyendo un commit anterior",
        body: "Este resultado es de {what}. El commit verificado más nuevo de esta herramienta es {newest}.",
        commitMade: "el commit {sha}, hecho el {committed}",
        commit: "el commit {sha}",
        cta: "Ver el más nuevo",
      },
    },
    panel: {
    ...
    howToRead: {
      ...
      chaptersHeading: "Tal como está en el repositorio, y qué tuvo que hacer STRhub",
      chaptersBody:
        "Cada informe abre con la herramienta tal como está en su repositorio: STRhub leyó las instrucciones del propio repositorio (el README, un Dockerfile o archivo de entorno, la imagen que el README señala) y corrió exactamente eso. La etiqueta es ese resultado, en palabras: \"Corre según su documentación\", o \"No corre según su documentación\" con dónde se detuvo. Es lo que encuentra quien usa la herramienta por primera vez. Una receta del mantenedor cuenta igual, porque es documentación en otro formato.",
      chaptersBody2:
        "Cuando STRhub escribió una receta propia para ver hasta dónde se podía hacer correr la herramienta, eso va segundo, bajo el título \"Qué tuvo que hacer STRhub para correr esta herramienta\": cada cosa que la receta tuvo que hacer distinto, como recomendación al autor, y hasta dónde llegó. Nunca cambia la etiqueta. Una herramienta sin corrida de sus propias instrucciones todavía se marca \"No verificada según su documentación\"; una cuyo README no dice lo suficiente para intentar correrla queda como \"No se pudo determinar\", un hallazgo sobre la documentación, no sobre el software.",
    ...
    certificate: {
      section: {
        ...
        why: "Por qué se detuvo, y qué reportó",
        reported: "Qué reportó la herramienta en el camino",
        command: "Comando exacto que corrió",
        metadata: "Metadatos de reproducibilidad",
        outOfScope: "Fuera de alcance",
        limitations: "Limitaciones",
        scope: "Alcance y descargos",
      ...
      cover: {
        ...
        notPublished: "No publicado. Es una corrida de prueba.",
        scope: "Alcance de este informe",
      },
      summary: {
        purpose: "Propósito",
        result: "Resultado",
      ...
      outOfScopeLead: "Este informe no evalúa nada de lo siguiente:",
    },
    headline: {
      ...
      stopsAt: {
        ...
        installs: "se detiene al correr",
        runs: "sin salida",
        io: "salida no plausible",
        content: "",
      },
    ...
    asIs: {
      heading: "Tal como está en el repositorio",
      fullRun: "Esta corrida, completa",
      details: "Detalles de la corrida",
    },
    strhubDid: {
      heading: "Qué tuvo que hacer STRhub para correr esta herramienta",
      lead: "STRhub escribió una receta propia para esta herramienta (un entorno y un comando propios, no las instrucciones del repositorio) y corrió eso.",
      leadAt: "STRhub escribió una receta propia para esta herramienta (un entorno y un comando propios, no las instrucciones del repositorio) y la corrió en {what}.",
      each: "Cada punto es algo que alguien que sigue el README por primera vez tendría que resolver por su cuenta.",
      insteadOf: "En lugar de:",
      why: "Por qué:",
      none: "No detallado para esta receta.",
      reached: "Con esos cambios, la corrida llegó a:",
      ...
      noLabelChange: "Esto no cambia la etiqueta de la herramienta. La etiqueta es lo que pasa tal como está en el repositorio.",
      readRun: "Leer esa corrida completa",
      rowNote: "Con la receta propia de STRhub, en este commit: {label}",
      notice: {
        title: "No verificada según su documentación",
        body: "Este es el informe completo de una corrida con una receta que escribió STRhub, no con las instrucciones del propio repositorio. Muestra hasta dónde se puede hacer correr la herramienta; no dice si alguien que sigue el README por primera vez llega hasta ahí, y no es la etiqueta de la herramienta.",
        seeDocumented: "Ver el resultado tal como está en el repositorio: {label}",
        noDocumented: "STRhub todavía no corrió esta herramienta desde sus propias instrucciones. El próximo refresh documentado lo hará, y ese resultado será la etiqueta.",
      },
    },
    ...
    content: {
      ...
      format: "Formato",
      maxDepth: "Locus más profundo",
      panelCoverage: "Loci del panel llamados",
      panelCoverageValue: "{hit} de {given}",
      notCalled: "Sin llamar:",
      notCalledHint: "Loci que el archivo de regiones pedía y que el output no nombra. Los autodiagnósticos de abajo suelen decir por qué.",
      ioChecksLabel: "Chequeos sobre el archivo",
      ioCheck: {
        exists: "existe",
        non_empty: "no está vacío",
        confined: "escrito dentro del directorio de salida",
        parses: "se lee como {format}",
        min_records: "tiene registros",
        must_contain: "contiene el texto declarado",
      },
      depthHeading: "Profundidad de lectura por locus",
      depthNote: "Reads que la herramienta reportó en cada locus que llamó, de mayor a menor. La profundidad refleja la cobertura del slice de referencia tanto como a la herramienta; está para que un lector vea que el output es real, no para rankear loci.",
      showAll: "Ver los {n}",
      showFewer: "Ver menos",
    },
    run: {
      heading: "Comando que se ejecutó",
      note: "Ejecutado tal cual dentro del contenedor, en el commit fijado. Las rutas bajo /data son los montajes de STRhub: la muestra de entrada, el genoma de referencia y el directorio de salida.",
    },
    data: {
    ...
    start: {
      ...
      title: {
        owner: "Verificar mi herramienta",
        reviewer: "Probar una herramienta para revisar un paper",
        user: "¿Es mi entorno, o la herramienta?",
      },
      lead: {
        owner: "Pegá tu repositorio. STRhub lo lee, deduce cómo instalarlo y correrlo, y lo prueba en un entorno limpio. No se publica nada hasta que vos lo digas.",
        reviewer: "Pegá el repositorio que cita el manuscrito. En unos minutos tenés una respuesta simple: ¿instala y corre como está documentado? Sin código, sin cuenta, sin publicar nada.",
        user: "Pegá el repositorio de la herramienta. STRhub muestra qué hace un entorno limpio con ella, para distinguir una falla de la herramienta de un problema en tu máquina.",
      },
      repoLabel: "Repositorio público de GitHub",
      ...
      refHow: {
        given: "el ref que diste",
        release: "último release",
        tag: "tag más reciente",
        head: "cabeza de la rama por defecto",
      },
      refUnresolved: "No se encontró ese repositorio o ref. Revisá la URL, o escribí un SHA de commit.",
      roleLabel: "Soy",
      role: {
        owner: "quien mantiene la herramienta",
        reviewer: "revisor de un paper sobre ella",
        user: "alguien intentando correrla",
      },
      cta: "Iniciar la prueba",
      starting: "Iniciando…",
      advanced: "Avanzado: escribir la receta a mano",
      advancedHint: "Para mantenedores que quieren controlar el Dockerfile, el comando y la salida esperada.",
      howItWorks: "Qué pasa",
      steps: {
        read: "STRhub lee el repositorio en el commit fijado: Dockerfile, archivos de entorno, README, datos de ejemplo.",
        propose: "Propone una receta: cómo instalar, qué correr, sobre cuál de sus datasets de referencia abiertos.",
        run: "Lo corre en un contenedor aislado, sin red, y revisa qué salió.",
        verdict: "Recibís una de cuatro respuestas: corre, falla, no se pudo determinar (con lo que el README no dice), o fuera de alcance.",
      },
      noPublish: "Una prueba no publica nada y es privado para quien tenga el link. Vence a los 30 días.",
      error: {
        not_a_github_repo: "Eso no es la URL de un repositorio público de GitHub.",
        repo_not_found: "Ese repositorio no existe o no es público.",
        ref_not_found: "Esa versión, tag o commit no está en el repositorio.",
        rate_limited: "Demasiadas pruebas desde acá por ahora. Probá en un rato.",
        not_configured: "Las pruebas todavía no están disponibles en este servidor.",
        generic: "No se pudo iniciar la prueba. Probá de nuevo.",
      },
    },
    trial: {
      title: "Prueba",
      of: "Prueba de {repo} en {ref}",
      state: {
        pending: "En cola. GitHub Actions está tomando la corrida.",
        queued: "En cola. GitHub Actions está tomando la corrida.",
        in_progress: "Corriendo: instalando la herramienta y ejecutándola en un contenedor limpio. Suele tardar de 2 a 10 minutos.",
        completed: "Terminado.",
        expired: "El resultado de esta prueba venció (se guardan 30 días). Iniciá uno nuevo.",
        stalled: "Todavía no hay corrida después de varios minutos. GitHub puede estar ocupado; el link sigue funcionando.",
      },
      elapsed: "Transcurrido: {minutes} min",
      verdict: {
        runs: "Corre",
        fails: "Falla",
        undetermined: "No se pudo determinar",
        out_of_scope: "Fuera del alcance de la verificación automática",
      },
      verdictMeaning: {
      ...
      gapsTitle: "Lo que el README no dice",
      knownIssuesTitle: "Lo que el autor documenta como problema conocido",
      knownIssuesHint: "Citado del README del repositorio en el commit verificado. STRhub no estableció nada de esto corriendo la herramienta; es la nota del propio autor sobre su propio software.",
      knownIssuesLine: "README línea {line}",
      evidenceTitle: "Evidencia",
      evidenceHint: "En qué se apoya la configuración de esta corrida, cada ítem en el commit verificado. Abrí cualquiera para comprobar la afirmación que sostiene.",
      evidenceClaim: {
        install_method: "Método de instalación",
        published_image: "Imagen publicada",
        bioconda_package: "Paquete de Bioconda",
        fallback_environment: "Entorno de respaldo",
        run_command: "Comando de ejecución",
        example_data: "Datos de ejemplo",
        known_issue: "Problema conocido",
        documented_input: "Entrada documentada",
        author_recommendation: "Recomendación del autor",
        platform_advice: "Advertencia sobre plataformas",
      },
      gapsHint: "Cada línea es algo que un desconocido necesita antes de poder correr la herramienta. Para un revisor son hallazgos de revisión; para quien la mantiene, una lista corta de pendientes.",
      noReport: "La corrida terminó sin producir un reporte. Suele significar que se detuvo antes de la primera compuerta; el log de la corrida tiene el detalle.",
      runLink: "Abrir la corrida en GitHub",
      recipeTitle: "Entorno en el que corrió",
      ...
      log: {
        build: "Build",
        external: "Corrida con datos de referencia de STRhub",
        own: "Corrida con datos del repositorio",
        example: "El ejemplo del propio README",
      },
      publish: "Publicar este resultado",
      publishHint: "Deja exactamente esta receta para que un admin de STRhub la apruebe. La aprobación corre la verificación real y lista la herramienta en el catálogo con un link permanente.",
      publishOnlyRuns: "Solo una prueba que terminó en \"Corre\" se publica con un clic. Corregí lo que dice el reporte y probá de nuevo, o usá el formulario avanzado.",
      published: "Enviado para aprobación como {slug}. No hace falta que vuelvas; la aprobación inicia la corrida.",
      publishError: {
        slug_taken: "Ya hay una herramienta con ese nombre y versión registrada para otro repositorio.",
        verdict_not_runs: "Esta prueba no terminó en \"Corre\".",
        trial_not_finished: "La prueba no terminó.",
        generic: "No se pudo enviar el resultado. Probá de nuevo.",
      },
      share: "Compartí este link con el editor o con otro revisor. No necesita cuenta.",
      again: "Probar otra herramienta",
      asOwnerCta: "¿Mantenés esta herramienta? Publicala desde esta página.",
      gates: "Compuertas",
      example: "Reproduce su propio ejemplo",
      exampleMeaning: "el comando del propio README produjo su salida documentada con los datos del propio repositorio",
      stoppedTitle: "Qué lo detuvo, y qué podés hacer",
      stoppedHint: "Cada ítem es una pieza que faltó. Podés agregarla vos y reintentar sin publicar nada, o pedírsela a quien mantiene la herramienta en GitHub.",
      selfFix: "Lo agrego yo y reintento",
      askOwner: "Pedírselo al dueño en GitHub",
      askOwnerHint: "Abre un issue ya redactado en el repositorio de la herramienta para que lo revises y publiques. STRhub no envía nada.",
      selfFixHint: "Abre la receta que STRhub propuso, con todo completado, en la sección a completar. La próxima corrida vuelve a ser una prueba.",
      pdf: "Descargar el informe PDF",
      html: "Abrir el informe completo",
      scopeTitle: "Alcance de este informe",
      scope1:
        "Verificación automática e independiente de ejecución reproducible. Confirma que la herramienta instala, corre de punta a punta y produce salida estructuralmente válida en un entorno estandarizado.",
      scope2:
        "No es una validación analítica. La exactitud de los genotipos, la concordancia, la aptitud forense y el cumplimiento regulatorio quedan fuera de alcance.",
    },
    check: {
      title: "¿Es mi entorno, o la herramienta?",
      lead: "Dos formas de saberlo. Si la herramienta ya está en el catálogo, compará con el entorno que la corrió. Si no, probala en un contenedor limpio. En cualquier caso, pegá tu error y STRhub te dice de qué tipo es.",
      lookupLabel: "Buscar la herramienta",
      found: "En el catálogo",
      foundHint: "Estas corridas listan el entorno exacto, el comando y el log. Si lo tuyo difiere de lo que funcionó acá, esa diferencia es el primer lugar donde mirar.",
      notFound: "Todavía no está en el catálogo. Probala abajo.",
      errorLabel: "Pegá el error que ves",
      errorPlaceholder: "Las últimas líneas de tu terminal…",
      errorCta: "¿Qué es esto?",
      errorNone: "Nada que STRhub reconozca. Compará tu comando y tu entorno con una corrida que funcionó.",
      errorKind: {
        cmd_not_found: "El programa no está en tu PATH. Suele ser que la instalación no terminó, o que el entorno (conda, venv) no está activado.",
        missing_module: "Falta un módulo de Python: las dependencias de la herramienta no están instaladas en el entorno desde el que corrés.",
        bad_option: "Un flag de línea de comando que la herramienta no reconoce. Revisá la versión: los flags cambian entre releases.",
        file_not_found: "La herramienta no encuentra un archivo de entrada en la ruta que diste.",
        cannot_open: "La herramienta no pudo abrir un archivo. Revisá la ruta y que el archivo sea lo que espera.",
        permission_denied: "Un problema de permisos en tu máquina, no de la herramienta.",
        oom: "El proceso se quedó sin memoria en tu máquina.",
        requires_gpu: "La herramienta necesita GPU, que tu máquina puede no tener.",
        conda_unsatisfiable: "conda no pudo resolver el entorno: suele ser una dependencia que ya no resuelve. Es un hallazgo sobre los pines de la herramienta.",
        pip_unresolvable: "pip no encontró una dependencia fijada. Es un hallazgo sobre los pines de la herramienta, no sobre tu entorno.",
        missing_header: "A una compilación C/C++ le falta una librería de desarrollo en tu máquina.",
      },
      seenHere: "STRhub vio el mismo tipo de error cuando corrió esta herramienta: probablemente es la herramienta, no vos.",
      notSeenHere: "STRhub no se topó con esto cuando corrió esta herramienta: mirá primero tu entorno.",
      rehearse: "Probarla en un contenedor limpio",
    },
  },
};
