...
communityHub: {
  ...
  hero: {
    ...
    subtitle:
      "Este espaço existe para fazer perguntas, compartilhar experiências, relatar o que funciona e o que não funciona, e ajudar a construir o que vem a seguir.",
    reality:
  ...
  communityContributors: {
    ...
    institutions: {
      ...
      ffclrp_usp: "FFCLRP, Universidade de São Paulo",
    },
    disclaimer:
  ...
  recentPosts: {
    ...
    readMore: "Ler Mais",
    viewAll: "Ver todos os artigos de Fundamentos",
