...
nav: {
  ...
  menu: {
    ...
    exploreFrequenciesDesc: "Gráficos por población y dataset",
    downloadDatasets: "Descargar datasets",
    downloadDatasetsDesc: "Tablas en Excel, CSV y JSON",
    referenceProjects: "Proyectos de referencia",
    referenceProjectsDesc: "1000 Genomas, gnomAD y otros recursos genómicos",
    igvViewer: "Visor IGV",
    igvViewerDesc: "Lecturas en loci STR sobre hg38",
...
home: {
  ...
  learnMore: "Saber Más",
  footer: {
    joinDiscussion: "Sumate a la discusión",
    mission:
