  ...
  en: {
    ...
    mixProfiles: {
      ...
      parameters: {
        ...
        atTooltip: "Analytical Threshold: Minimum RFU to distinguish a peak from baseline noise.\n\nTypical: 50–100 RFU.\n\nLower AT shows more minor peaks; higher AT reduces noise visibility.",
        stTooltip: "Stochastic Threshold: RFU level where allele imbalance becomes unlikely.\n\nTypical: 150–200 RFU.\n\nPeaks below ST may indicate risk of heterozygote drop-out.",
      ...
      quickGuide: {
        ...
        button: "Quick Guide",
        parameters: {
          title: "1. Key Parameters",
          at: "AT (Analytical Threshold): Minimum RFU to visualize a peak.",
          st: "ST (Stochastic Threshold): RFU level for confidence in heterozygotes.",
          noiseBase: "Noise/Base: Simulates baseline fluctuations.",
          stutterLevel: "Stutter level (×): Multiplies natural stutter rate (for teaching).",
          degradationK: "Degradation k: Higher k reduces signal in longer fragments first.",
        },
        mixture: {
          title: "2. Typical Mixture Ratios",
        ...
        markers: {
          title: "3. Markers with clearer stutter behavior",
          description: "Loci with longer alleles often show more noticeable effects.",
          fga: "FGA",
          d18s51: "D18S51",
          d21s11: "D21S11",
          d2s1338: "D2S1338",
        ...
        simulation: {
          ...
          loci: "Prefer loci with n / (n−1) allele patterns between contributors",
        },
        notes: {
          title: "5. Practical Notes",
          longerAlleles: "Longer alleles degrade faster.",
          minorContributors: "Minor contributors drop in RFU sooner under degradation.",
          stutter: "Stutter is more visible when the major contributor dominates.",
          notAllLoci: "Not all loci show the effect equally.",
        },
      },
    },
  },
  pt: {
    ...
    mixProfiles: {
      ...
      parameters: {
        ...
        atTooltip: "Limiar Analítico: RFU mínimo para distinguir um pico do ruído de linha de base.\n\nTípico: 50–100 RFU.\n\nAT menor mostra mais picos menores; AT maior reduz a visibilidade do ruído.",
        stTooltip: "Limiar Estocástico: Nível de RFU onde o desequilíbrio alélico se torna improvável.\n\nTípico: 150–200 RFU.\n\nPicos abaixo de ST podem indicar risco de perda de heterozigoto.",
      ...
      quickGuide: {
        ...
        button: "Guia Rápido",
        parameters: {
          title: "1. Parâmetros Principais",
          at: "AT (Limiar Analítico): RFU mínimo para visualizar um pico.",
          st: "ST (Limiar Estocástico): Nível de RFU para confiança em heterozigotos.",
          noiseBase: "Ruído/Base: Simula flutuações da linha de base.",
          stutterLevel: "Nível de stutter (×): Multiplica a taxa natural de stutter (para ensino).",
          degradationK: "Degradação k: k maior reduz o sinal em fragmentos mais longos primeiro.",
        },
        mixture: {
          title: "2. Proporções Típicas de Mistura",
        ...
        markers: {
          title: "3. Marcadores com comportamento de stutter mais claro",
          description: "Loci com alelos mais longos frequentemente mostram efeitos mais notáveis.",
          fga: "FGA",
          d18s51: "D18S51",
          d21s11: "D21S11",
          d2s1338: "D2S1338",
        ...
        simulation: {
          ...
          loci: "Prefira loci com padrões alélicos n / (n−1) entre contribuidores",
        },
        notes: {
          title: "5. Notas Práticas",
          longerAlleles: "Alelos mais longos degradam mais rápido.",
          ...
          notAllLoci: "Nem todos os loci mostram o efeito igualmente.",
        },
      },
    },
  },
  es: {
    ...
    mixProfiles: {
      ...
      parameters: {
        ...
        atTooltip: "Umbral Analítico: RFU mínimo para distinguir un pico del ruido de línea de base.\n\nTípico: 50–100 RFU.\n\nAT menor muestra más picos menores; AT mayor reduce la visibilidad del ruido.",
        stTooltip: "Umbral Estocástico: Nivel de RFU donde el desequilibrio alélico se vuelve improbable.\n\nTípico: 150–200 RFU.\n\nPicos por debajo de ST pueden indicar riesgo de pérdida de heterocigoto.",
      ...
      quickGuide: {
        ...
        button: "Guía Rápida",
        parameters: {
          title: "1. Parámetros Clave",
          at: "AT (Umbral Analítico): RFU mínimo para visualizar un pico.",
          st: "ST (Umbral Estocástico): Nivel de RFU para confianza en heterocigotos.",
          noiseBase: "Ruido/Base: Simula fluctuaciones de la línea de base.",
          stutterLevel: "Nivel de stutter (×): Multiplica la tasa natural de stutter (para enseñanza).",
          degradationK: "Degradación k: k mayor reduce la señal en fragmentos más largos primero.",
        },
        mixture: {
          title: "2. Proporciones Típicas de Mezcla",
          balanced: "50/50 → equilibrada",
        ...
        markers: {
          title: "3. Marcadores con comportamiento de stutter más claro",
          description: "Loci con alelos más largos a menudo muestran efectos más notables.",
          fga: "FGA",
          d18s51: "D18S51",
          d21s11: "D21S11",
          d2s1338: "D2S1338",
        ...
        simulation: {
          ...
          loci: "Prefiera loci con patrones alélicos n / (n−1) entre contribuidores",
        },
        notes: {
          title: "5. Notas Prácticas",
          longerAlleles: "Los alelos más largos se degradan más rápido.",
          ...
          notAllLoci: "No todos los loci muestran el efecto por igual.",
        },
      },
    },
  },
