...
nav: {
  ...
  menu: {
    exploreFrequencies: "Explorar frequências",
    exploreFrequenciesDesc: "Gráficos por população e dataset",
    downloadDatasets: "Baixar datasets",
    downloadDatasetsDesc: "Tabelas em Excel, CSV e JSON",
    referenceProjects: "Projetos de referência",
    referenceProjectsDesc: "1000 Genomas, gnomAD e outros recursos genômicos",
    igvViewer: "Visualizador IGV",
    igvViewerDesc: "Leituras em loci STR sobre o hg38",
