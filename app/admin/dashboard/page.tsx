...
import { Database, Plus, Edit, Trash2, LogOut, FileText, Users, BookOpen } from "lucide-react"
...
export default function AdminDashboard() {
  ...
  const [category, setCategory] = useState<"Blog" | "Projects" | "Educational">("Blog")
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>Manage blog posts, projects, and educational content</CardDescription>
              </div>
              <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                ...
                <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                  <DialogHeader>
                    ...
                    <DialogDescription>Add a new content entry to your site</DialogDescription>
                  </DialogHeader>
                ...
                {entries.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={4} className="text-center py-8 text-muted-foreground">
                      No content entries yet. Create your first entry to get started.
                    </TableCell>
                  </TableRow>
                ) : (
                  entries.map((entry) => (
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <MarkdownEditor value={content} onChange={setContent} placeholder="Enter content using Markdown..." />
              </div>
            </div>
            <DialogFooter>
