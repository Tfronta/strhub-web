export default {
  verified: {
    ...
    start: {
      ...
      lead: {
        owner: "Cole seu repositório. O STRhub lê, deduz como instalar e executar, e ensaia isso em um ambiente limpo. Nada é publicado até você dizer.",
      ...
      noPublish: "Um ensaio não publica nada e é privado para quem tiver o link. Expira em 30 dias.",
      error: {
        ...
        rate_limited: "Ensaios demais daqui por enquanto. Tente de novo mais tarde.",
        not_configured: "Os ensaios ainda não estão disponíveis neste servidor.",
        generic: "Não foi possível iniciar o ensaio. Tente de novo.",
      },
    },
    trial: {
      title: "Ensaio",
      of: "Ensaio de {repo} em {ref}",
      state: {
        ...
        completed: "Concluído.",
        expired: "O resultado deste ensaio expirou (resultados ficam 30 dias). Inicie um novo.",
      ...
      publishOnlyRuns: "Só um ensaio que terminou em \"Roda\" pode ser publicado com um clique. Corrija o que o relatório diz e ensaie de novo, ou use o formulário avançado.",
      ...
      publishError: {
        ...
        verdict_not_runs: "Este ensaio não terminou em \"Roda\".",
        trial_not_finished: "O ensaio não terminou.",
      ...
      again: "Ensaiar outra ferramenta",
    ...
    check: {
      ...
      lead: "Duas formas de saber. Se a ferramenta já está no catálogo, compare com o ambiente que a executou. Se não, ensaie em um contêiner limpo. Em qualquer caso, cole seu erro e o STRhub diz de que tipo é.",
      ...
      notFound: "Ainda não está no catálogo. Ensaie abaixo.",
      ...
      rehearse: "Ensaiar em um contêiner limpo",
    },
  },
};
