...
nav: {
  ...
  menu: {
    ...
    exploreFrequenciesDesc: "Charts by population and dataset",
    downloadDatasets: "Download datasets",
    downloadDatasetsDesc: "Tables in Excel, CSV and JSON",
    referenceProjects: "Reference projects",
    referenceProjectsDesc: "1000 Genomes, gnomAD and other genomic resources",
    igvViewer: "IGV Viewer",
    igvViewerDesc: "Browse reads at STR loci on hg38",
