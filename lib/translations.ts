export const translations = {
  en: {
    ...
    globalFrequencies: {
      ...
      subtitle: "Designed to explore and compare allele frequency distributions across populations within harmonized forensic datasets.",
      explanation: "Allele frequency datasets are organized by technology and study design. CE and NGS datasets are shown independently because they are not directly comparable due to methodological differences. Comparisons are valid only within each dataset, following its original analytical framework.",
      controls: "Controls",
      dataset: "Dataset",
      ...
      // CE Dataset
      ceDataset: {
        source: "Frequencies are derived from harmonized CE (Capillary Electrophoresis) data from pop.STR / SP-SMART database.",
        notes: "Data uses consistent kit and allele definitions across populations, enabling valid comparisons within this CE dataset.",
      ...
      ngs1000G: {
        ...
        notes: "Based on 2,504 individuals from 26 populations. STR alleles were genotyped from high-coverage WGS data.",
      ...
      ngsRAO: {
        ...
        notes: "Consensus STR genotypes obtained across HipSTR, STRait Razor and toaSTR. Targeted forensic panel design.",
  ...
  pt: {
    ...
    globalFrequencies: {
      ...
      subtitle: "Projetado para explorar e comparar distribuições de frequência alélica entre populações dentro de conjuntos de dados forenses harmonizados.",
      explanation: "Os conjuntos de dados de frequência alélica são organizados por tecnologia e desenho do estudo. Os conjuntos de dados CE e NGS são mostrados independentemente porque não são diretamente comparáveis devido a diferenças metodológicas. As comparações são válidas apenas dentro de cada conjunto de dados, seguindo sua estrutura analítica original.",
      controls: "Controles",
      ...
      ceDataset: {
        source: "As frequências são derivadas de dados CE (Eletroforese Capilar) harmonizados do banco de dados pop.STR / SP-SMART.",
        notes: "Os dados usam kit e definições de alelos consistentes entre populações, permitindo comparações válidas dentro deste conjunto de dados CE.",
        comparability: "As comparações são válidas dentro deste conjunto de dados CE harmonizado. Não são diretamente comparáveis a frequências baseadas em NGS.",
      },
      ngs1000G: {
        ...
        notes: "Baseado em 2.504 indivíduos de 26 populações. Os alelos STR foram genotipados a partir de dados WGS de alta cobertura.",
      ...
      ngsRAO: {
        ...
        notes: "Genótipos STR consenso obtidos entre HipSTR, STRait Razor e toaSTR. Design de painel forense direcionado.",
  ...
  es: {
    ...
    globalFrequencies: {
      ...
      subtitle: "Diseñado para explorar y comparar distribuciones de frecuencia alélica entre poblaciones dentro de conjuntos de datos forenses armonizados.",
      explanation: "Los conjuntos de datos de frecuencia alélica están organizados por tecnología y diseño del estudio. Los conjuntos de datos CE y NGS se muestran de forma independiente porque no son directamente comparables debido a diferencias metodológicas. Las comparaciones son válidas solo dentro de cada conjunto de datos, siguiendo su marco analítico original.",
      controls: "Controles",
      ...
      ceDataset: {
        source: "Las frecuencias se derivan de datos CE (Electroforesis Capilar) armonizados de la base de datos pop.STR / SP-SMART.",
        notes: "Los datos utilizan kit y definiciones de alelos consistentes entre poblaciones, permitiendo comparaciones válidas dentro de este conjunto de datos CE.",
        comparability: "Las comparaciones son válidas dentro de este conjunto de datos CE armonizado. No son directamente comparables a frecuencias basadas en NGS.",
      },
      ngs1000G: {
        ...
        notes: "Basado en 2.504 individuos de 26 poblaciones. Los alelos STR fueron genotipados a partir de datos WGS de alta cobertura.",
      ...
      ngsRAO: {
        ...
        notes: "Genotipos STR consenso obtenidos entre HipSTR, STRait Razor y toaSTR. Diseño de panel forense dirigido.",
