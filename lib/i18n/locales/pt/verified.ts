export default {
  verified: {
    ...
    start: {
      ...
      refHint: "Preenchido para você com o último release assim que cola o repositório. Mude para verificar outra versão. O resultado fica sempre fixado a um commit.",
