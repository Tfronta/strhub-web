export default {
  verified: {
    ...
    caveats: {
      ...
      note: "Registradas automaticamente ao configurar esta execução, por {origin} lendo os arquivos públicos da ferramenta. Não verificadas por execução, e não fazem parte dos portões acima. Úteis para saber o que conferir à mão.",
    },
    log: {
