export default {
  verified: {
    ...
    start: {
      ...
      lead: {
        owner: "Paste your repository. STRhub reads it, works out how to install and run it, and rehearses that in a clean environment. Nothing is published until you say so.",
      ...
      noPublish: "A rehearsal publishes nothing and is private to whoever has its link. It expires after 30 days.",
      error: {
        ...
        rate_limited: "Too many rehearsals from here for now. Try again in a while.",
        not_configured: "Rehearsals are not available on this server yet.",
        generic: "Could not start the rehearsal. Try again.",
      },
    },
    trial: {
      title: "Rehearsal",
      of: "Rehearsal of {repo} at {ref}",
      state: {
        ...
        completed: "Finished.",
        expired: "This rehearsal's result has expired (results are kept 30 days). Start a new one.",
      ...
      publishOnlyRuns: "Only a rehearsal that ended in \"Runs\" can be published with one click. Fix what the report says and rehearse again, or use the advanced form.",
      ...
      publishError: {
        ...
        verdict_not_runs: "This rehearsal did not end in \"Runs\".",
        trial_not_finished: "The rehearsal has not finished.",
        generic: "Could not file the result. Try again.",
      },
      share: "Share this link with the editor or a co-reviewer. It needs no account.",
      again: "Rehearse another tool",
      ...
      selfFixHint: "Opens the recipe STRhub proposed, with everything filled in, at the section to complete. The next run is a rehearsal again.",
      pdf: "Download the PDF report",
      html: "Open the full report",
    },
    check: {
      title: "Is it my setup, or the tool?",
      lead: "Two ways to find out. If the tool is already in the catalogue, compare with the environment that ran it. If not, rehearse it in a clean container. Either way, paste your error and STRhub tells you what kind it is.",
      ...
      notFound: "Not in the catalogue yet. Rehearse it below.",
      ...
      rehearse: "Rehearse it in a clean container",
    },
  },
};
