export default {
  verified: {
    ...
    start: {
      ...
      refHint: "Se completa solo con el último release apenas pegás el repositorio. Cambialo para verificar otra versión. El resultado siempre queda fijado a un commit.",
