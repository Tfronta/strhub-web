...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      // text-base md:text-sm mirrors Input exactly: a select sitting next to a
      // text field was a size larger than it on desktop, because Input steps
      // down at md and this did not.
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-xs font-semibold text-foreground not-first:mt-2",
      className,
    )}
    {...props}
  />
