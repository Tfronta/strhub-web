export default {
  verified: {
    ...
    start: {
      ...
      lead: {
        owner: "Pegá tu repositorio. STRhub lo lee, deduce cómo instalarlo y correrlo, y lo ensaya en un entorno limpio. No se publica nada hasta que vos lo digas.",
      ...
      noPublish: "Un ensayo no publica nada y es privado para quien tenga el link. Vence a los 30 días.",
      error: {
        ...
        rate_limited: "Demasiados ensayos desde acá por ahora. Probá en un rato.",
        not_configured: "Los ensayos todavía no están disponibles en este servidor.",
        generic: "No se pudo iniciar el ensayo. Probá de nuevo.",
      },
    },
    trial: {
      title: "Ensayo",
      of: "Ensayo de {repo} en {ref}",
      state: {
        ...
        completed: "Terminado.",
        expired: "El resultado de este ensayo venció (se guardan 30 días). Iniciá uno nuevo.",
      ...
      publishOnlyRuns: "Solo un ensayo que terminó en \"Corre\" se publica con un clic. Corregí lo que dice el reporte y ensayá de nuevo, o usá el formulario avanzado.",
      ...
      publishError: {
        ...
        verdict_not_runs: "Este ensayo no terminó en \"Corre\".",
        trial_not_finished: "El ensayo no terminó.",
      ...
      again: "Ensayar otra herramienta",
      ...
      selfFixHint: "Abre la receta que STRhub propuso, con todo completado, en la sección a completar. La próxima corrida vuelve a ser un ensayo.",
    ...
    check: {
      ...
      lead: "Dos formas de saberlo. Si la herramienta ya está en el catálogo, compará con el entorno que la corrió. Si no, ensayala en un contenedor limpio. En cualquier caso, pegá tu error y STRhub te dice de qué tipo es.",
      ...
      notFound: "Todavía no está en el catálogo. Ensayala abajo.",
      ...
      rehearse: "Ensayarla en un contenedor limpio",
    },
  },
};
