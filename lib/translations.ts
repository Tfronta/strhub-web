export const translations = {
  en: {
    ...
    // Global Frequencies (keeping for backward compatibility, but will be replaced)
    globalFrequencies: {
    ...
    mixProfiles: {
      ...
      ceChart: {
        ...
        tooltipArea: "Peak area: {area} (integrated signal)",
  ...
  pt: {
    ...
    mixProfiles: {
      ...
      ceChart: {
        ...
        tooltipArea: "Área do pico: {area} (sinal integrado)",
  ...
  es: {
    ...
    mixProfiles: {
      ...
      ceChart: {
        ...
        tooltipArea: "Área del pico: {area} (señal integrada)",
